...
import { Menu, X, Instagram, Twitter, Facebook, ArrowRight, Users, Store, DollarSign } from 'lucide-react'
      ...
      <main>
        <section id="home" className="container mx-auto px-4 py-20 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4">
            <button className="bg-white text-purple-700 px-8 py-3 rounded-full font-semibold hover:bg-purple-100 transition">Soy Creador</button>
            <button className="bg-purple-500 px-8 py-3 rounded-full font-semibold hover:bg-purple-400 transition">Soy Restaurante</button>
          </div>
        </section>
        ...
        <section id="contact" className="bg-purple-900 py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8">Únete a Chivos hoy y lleva tus colaboraciones al siguiente nivel</p>
            <button className="bg-white text-purple-700 px-8 py-3 rounded-full font-semibold hover:bg-purple-100 transition">Contáctanos</button>
          </div>
        </section>
      </main>
